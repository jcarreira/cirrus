...
class CrossValidation(MLJob):
  def __init__(self, other_job = GridSearch, k = 10, hyper_vars = [], hyper_params = [], param_base, num_sets):
    MLJob.__init__(other_job)
    ...
    for i in range(k):
      ...
      self.cirrus_objs.append(self.other_job(task=cirrus.LogisticRegression,
