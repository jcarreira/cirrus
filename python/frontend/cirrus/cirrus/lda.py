...
class LDATask:
    ...
    def define_config(self, ip):
        ...
        config = "vocab_path: ../../nytimes_vocab.txt \n" + \
        ...
        stdin, stdout, stderr = client.exec_command('echo "%s" > config_lda.txt' % config)
        print stdout.read()
