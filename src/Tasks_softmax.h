...
class LogisticTask : public MLTask {
 public:
  LogisticTask(const std::string& IP,
               const std::string& PORT,
               uint64_t batch_size,
               uint64_t samples_per_batch,
               uint64_t features_per_sample,
...
class LogisticTaskPreloaded : public MLTask {
 public:
  LogisticTaskPreloaded(const std::string& IP,
                        const std::string& PORT,
                        uint64_t batch_size,
                        uint64_t samples_per_batch,
                        uint64_t features_per_sample,
...
class LoadingTask : public MLTask {
 public:
  LoadingTask(const std::string& IP,
              const std::string& PORT,
              uint64_t batch_size,
              uint64_t samples_per_batch,
              uint64_t features_per_sample,
