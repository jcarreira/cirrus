...
public:
  ...
  /**
    ...
    * @param n Number of coordinates
    */
  SparseLRSDCAModel(const FEATURE_TYPE *w, uint64_t d, const FEATURE_TYPE *a, uint64_t n);
  ...
  /**
   * Performs an SGD (SDCA in this case) update in the direction of the input gradient
  ...
  std::vector<FEATURE_TYPE> get_coord_weights() {
    return coord_weights_;
  }
