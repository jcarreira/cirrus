...
LRModel lr_model_deserializer::operator()(const void* data,
...
LRGradient lr_gradient_deserializer::operator()(const void* data,
                                                unsigned int des_size) {
...
void sm_gradient_serializer::serialize(const SoftmaxGradient& g,
                                       void* mem) const {
  g.serialize(mem);
}

SoftmaxGradient sm_gradient_deserializer::operator()(const void* data,
                                                     unsigned int des_size) {
...
void sm_model_serializer::serialize(const SoftmaxModel& model,
                                    void* mem) const {
  model.serializeTo(mem);
}

SoftmaxModel sm_model_deserializer::operator()(const void* data,
                                               unsigned int des_size) {
