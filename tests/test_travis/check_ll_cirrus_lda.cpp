...
//     cirrus::Configuration("../../configs/lda_test.cfg");
...
// }
//
// double compute_ll(LDAUpdates& global_var,
//                   std::vector<LDAStatistics>& local_vars) {
//   std::vector<int> nvt, nt;
...
//       model_lock.lock();
//
//       char* partial_model = global_var.get_partial_model(
//           local_var_slice->serialize_slice(), to_send_size);
...
//     threads.push_back(std::make_shared<std::thread>(sample, i));
//   }
//
//   // Eval
//
